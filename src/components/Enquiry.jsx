      ...
      <div className="enquiry">
        ...
        <div className="main-head">
                ...
                <div className="table-header enq">
                    ...
                    <div className="box">
                        <button><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Rahul</td>
                                    <td>9876543210</td>
                                    <td>rahul.darahul.gupta14@gmail.com</td>
                                    <td>12-01-2024</td>
                                    <td><select>
                                        <option value="" class="green_color">Contacted</option>
                ...
                <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link text-light bg-dark rounded-2 mx-1" href="#">1</a></li>
                    <li class="page-item"><a class="page-link text-light bg-dark rounded-2 mx-1" href="#">2</a></li>
                    <li class="page-item"><a class="page-link text-light bg-dark rounded-2 mx-1" href="#">3</a></li>
                    <li class="page-item">
